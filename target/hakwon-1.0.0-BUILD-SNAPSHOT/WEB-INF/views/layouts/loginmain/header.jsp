...
<%--&lt;%&ndash;					<button class="btn btn-outline-light me-2" onclick="location.href = 'main'" type="submit"> 로그아웃</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;				</form>&ndash;%&gt;--%>
<%--&lt;%&ndash;				<button type="button" class="btn btn-warning">My Page</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;			</div>&ndash;%&gt;--%>
<%--		</div>--%>
<%--	</div>--%>
<%--</header>--%>
