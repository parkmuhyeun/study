...
%>
	<!-- header -->
	<div id="header2">
		<h1><a href="/infl/analysis.do"><img src="/images/logo22.png" alt="경기도 상권영향정보 서비스"></a></h1>
		<div class="mTab3" id="topMenu"  >
			<c:if test="${fn:indexOf(authList,'AFFC_LC') > -1}" >
				<a href="/infl/status.do" id="topMenu1"  >현황판</a>
			</c:if>
			<c:if test="${fn:indexOf(authList,'AFFC_LC') > -1 || fn:indexOf(authList,'AFFC_BZ') > -1}" >
				<a href="/infl/analysis.do" id="topMenu2" >상권영향분석</a>
			</c:if>
		</div>
		<div class="gRt">
			<span class="link">
				...
				<span class="bar">|</span>
				<a href="/sg_user_manual2.pdf">도움말</a>
			</span>
			<span class="log">
				<% if (!MBR_ID.equals("")) { %>
				<span class="gLog">
		...
		<div class="mGnb2">
			<ul>
				<% if (!MBR_ID.equals("")) { %>
				<li class="nobar"><a href="/passni/jsp/intergration/ssoLink.jsp?appid=sgbiz_trd">상권영향분석 서비스</a></li>
				<% } else { %>
				<li class="nobar"><a href="http://sbiz.gmr.or.kr/main.do">상권영향분석 서비스</a></li>
				<% } %>	
