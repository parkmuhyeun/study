...
%>
	...
	<div id="header2">
			<h1>
				<span class="img"><a href="/mnt/oldstore.do"><img src="/images/logo21_policy.png" alt="경기도 정책지원 서비스"></a></span>
			</h1>
			<div class="gRt">
				<span class="link">
			...
			<div class="mGnb2">
				...
				<% if (!MBR_ID.equals("")) { %>
				<li><a href="/passni/jsp/intergration/ssoLink.jsp?appid=sgbiz_trd">상권영향분석 서비스</a></li>
				<% } else { %>
				<li><a href="http://sbiz.gmr.or.kr/main.do">상권영향분석 서비스</a></li>
				<% } %>	
