...
%>
	...
	<div id="header2">
		<div class="bg">	
			<h1>
				<span class="img"><a href="/passni/jsp/intergration/ssoLink.jsp?appid=sgbiz_trd"><img src="/images/logo21.png" alt="경기도 상권영향분석 서비스"></a></span>
			</h1>
			<div class="gRt">
				<span class="link">
